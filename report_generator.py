...
def generate_user_activity_report(yearly_reports_path, user_name, start_date, end_date, output_file):
    ...
    """
    user_file = os.path.join(yearly_reports_path, f"{datetime.now().year}-{user_name}.csv")
    activity_data = []

    if not os.path.isfile(user_file):
        print(f"Yearly user file not found for user '{user_name}'.")
        return
    ...
    if activity_data:
        ...
        print(f"User activity report generated: {output_file}")
    else:
        print(f"No activity found for user '{user_name}' in the specified time period.")
...
def run_project_report(yearly_reports_path, project_name, output_file):
    ...
    tk.messagebox.showinfo("Success", f"Project report generated: {output_file}")
...
def run_user_activity_report(yearly_reports_path, user_name, start_date_str, end_date_str, output_file):
    ...
    tk.messagebox.showinfo("Success", f"User activity report generated: {output_file}")
